...
type Application = {
  ...
  user_id: string;
  job_id: string;
  status: 'pending' | 'applied' | 'interviewing' | 'offered' | 'rejected' | 'withdrawn';
  applied_at: string;
  notes: string;
  job: {
    id: string;
...
const STATUS_COLUMNS = [
  { key: 'pending', title: 'Queue / Pending', color: 'var(--text-muted)' },
  { key: 'applied', title: 'Submitted', color: '#3b82f6' },
  { key: 'interviewing', title: 'Interviewing', color: 'var(--color-warning)' },
  { key: 'offered', title: 'Offers Received', color: 'var(--color-accent)' },
  { key: 'rejected', title: 'Archives / Rejected', color: 'var(--color-danger)' }
];
...
export default function Tracker() {
  ...
  // Helper to filter applications by column
      ...
      <div className="container">
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2.5rem' }}>
          <div>
            ...
            <p>Track your automated submissions and update interview scheduling status.</p>
          </div>
          <button onClick={() => router.push('/dashboard')} className="btn btn-primary" style={{ gap: '0.5rem' }}>
            <Plus size={16} />
